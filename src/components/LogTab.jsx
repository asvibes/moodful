...
export function LogTab({ entries, addOrUpdate }) {
  ...
  return (
    <div style={{ padding: "0 4px" }}>
      ...
      <p style={{ fontSize: 13, fontWeight: 600, color: "#6B7280", marginBottom: 10, letterSpacing: 0.5 }}>JOURNAL ENTRY</p>
      <textarea value={note} onChange={(e) => setNote(e.target.value)}
        placeholder="What is on your mind today?" rows={5}
      ...
      <button onClick={save} disabled={!mood} style={{
        ...
        {existing ? "Update Todays Entry" : "Save Todays Mood"}
      </button>
